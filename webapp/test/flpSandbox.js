		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "sales project",
									"targetURL": "#salesproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"salesproject-display": {
								"semanticObject": "salesproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=salesproject",
									"url": sap.ui.require.toUrl("salesproject")
								}
							}
						}
					}
